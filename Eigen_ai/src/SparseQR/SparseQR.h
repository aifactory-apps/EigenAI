...
#ifndef EIGEN_AI_SPARSE_QR_H
#define EIGEN_AI_SPARSE_QR_H
...
{
  eigen_assert(mat.isCompressed() && "SparseQR requires a sparse matrix in compressed mode. Call .makeCompressed() before passing it to SparseQR.h");
