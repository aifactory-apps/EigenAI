...
#ifndef EIGEN_AI_COMPLEX_CUDA_H
#define EIGEN_AI_COMPLEX_CUDA_H
...
template<typename T> struct scalar_sum_op<const std::complex<T>, const std::complex<T> > : binary_op_base<const std::complex<T>, const std::complex<T> > {
  ...
  EIGEN_AI_DEVICE_FUNC EIGEN_AI_STRONG_INLINE std::complex<T> operator() (const std::complex<T>& a, const std::complex<T>& b) const {
