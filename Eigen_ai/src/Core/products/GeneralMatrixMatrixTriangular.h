...
#ifndef EIGEN_AI_GENERAL_MATRIX_MATRIX_TRIANGULAR_H
#define EIGEN_AI_GENERAL_MATRIX_MATRIX_TRIANGULAR_H
...
struct general_matrix_matrix_triangular_product<Index,LhsScalar,LhsStorageOrder,ConjugateLhs,RhsScalar,RhsStorageOrder,ConjugateRhs,RowMajor,UpLo,Version>
{
  ...
  static EIGEN_AI_STRONG_INLINE void run(Index size, Index depth,const LhsScalar* lhs, Index lhsStride,
...
{
  typedef typename ScalarBinaryOpTraits<LhsScalar, RhsScalar>::ReturnType ResScalar;
  static EIGEN_AI_STRONG_INLINE void run(Index size, Index depth,const LhsScalar* _lhs, Index lhsStride,
...
struct tribb_kernel
{
  ...
  enum {
    BlockSize  = meta_least_common_multiple<EIGEN_AI_PLAIN_ENUM_MAX(mr,nr),EIGEN_AI_PLAIN_ENUM_MIN(mr,nr)>::ret
  };
...
{
  EIGEN_AI_STATIC_ASSERT((UpLo&UnitDiag)==0, WRITING_TO_TRIANGULAR_PART_WITH_UNIT_DIAGONAL_IS_NOT_SUPPORTED);
...
#endif // EIGEN_AI_GENERAL_MATRIX_MATRIX_TRIANGULAR_H
