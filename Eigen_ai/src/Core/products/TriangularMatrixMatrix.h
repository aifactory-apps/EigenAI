...
#ifndef EIGEN_AI_TRIANGULAR_MATRIX_MATRIX_H
#define EIGEN_AI_TRIANGULAR_MATRIX_MATRIX_H
...
// {
//   Matrix<Scalar,mr,mr,
//   void operator()(Scalar* blockA, const EIGEN_AI_RESTRICT Scalar* _lhs, int lhsStride, int depth, int rows)
//   {
                                           ...
                                           RhsStorageOrder,ConjugateRhs,ColMajor,Version>
{
  ...
  enum {
    SmallPanelWidth   = 2 * EIGEN_AI_PLAIN_ENUM_MAX(Traits::mr,Traits::nr),
...
template <typename Scalar, typename Index, int Mode,
          int LhsStorageOrder, bool ConjugateLhs,
          int RhsStorageOrder, bool ConjugateRhs, int Version>
EIGEN_AI_DONT_INLINE void product_triangular_matrix_matrix<Scalar,Index,Mode,true,
                                                        LhsStorageOrder,ConjugateLhs,
                                        ...
                                        RhsStorageOrder,ConjugateRhs,ColMajor,Version>
{
  typedef gebp_traits<Scalar,Scalar> Traits;
  enum {
    SmallPanelWidth   = EIGEN_AI_PLAIN_ENUM_MAX(Traits::mr,Traits::nr),
    IsLower = (Mode&Lower) == Lower,
    SetDiag = (Mode&(ZeroDiag|UnitDiag)) ? 0 : 1
  };
...
template <typename Scalar, typename Index, int Mode,
          int LhsStorageOrder, bool ConjugateLhs,
          int RhsStorageOrder, bool ConjugateRhs, int Version>
EIGEN_AI_DONT_INLINE void product_triangular_matrix_matrix<Scalar,Index,Mode,false,
                                                        LhsStorageOrder,ConjugateLhs,
                                                        RhsStorageOrder,ConjugateRhs,ColMajor,Version>::run(
    Index _rows, Index _cols, Index _depth,
    const Scalar* _lhs, Index lhsStride,
    ...
    const Scalar& alpha, level3_blocking<Scalar,Scalar>& blocking)
  {
    ...
    std::size_t sizeA = kc*mc;
    std::size_t sizeB = kc*cols+EIGEN_AI_MAX_ALIGN_BYTES/sizeof(Scalar);
...
#endif // EIGEN_AI_TRIANGULAR_MATRIX_MATRIX_H
