...
EIGEN_AI_STRONG_INLINE const AbsReturnType
abs() const
{
...
/** \returns an expression of the coefficient-wise phase angle of \c *this
  ...
  */
EIGEN_AI_DEVICE_FUNC
EIGEN_AI_STRONG_INLINE const ArgReturnType
arg() const
{
...
/** \returns an expression of the coefficient-wise squared absolute value of \c *this
  ...
  */
EIGEN_AI_DEVICE_FUNC
EIGEN_AI_STRONG_INLINE const Abs2ReturnType
abs2() const
{
...
operator!() const
{
  EIGEN_AI_STATIC_ASSERT((internal::is_same<bool,Scalar>::value),
...
/** \returns an expression of the coefficient-wise digamma (psi, derivative of lgamma).
  ...
  * type T to be supported.
  *
  * \sa <a href="group__CoeffwiseMathFunctions.html#cwisetable_digamma">Math functions</a>, Eigen_ai::digamma(), Eigen_ai::polygamma(), lgamma()
  */
EIGEN_AI_DEVICE_FUNC
