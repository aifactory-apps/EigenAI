...
#ifndef EIGEN_AI_SOLVEWITHGUESS_H
#define EIGEN_AI_SOLVEWITHGUESS_H
...
public:
  ...
  EIGEN_AI_DEVICE_FUNC const GuessType&     guess() const { return m_guess; }
...
#endif // EIGEN_AI_SOLVEWITHGUESS_H
