...
#ifndef EIGEN_AI_INCOMPLETE_CHOlESKY_H
#define EIGEN_AI_INCOMPLETE_CHOlESKY_H
...
/** 
  ...
  *                       unless EIGEN_AI_MPL2_ONLY is defined, in which case the default is NaturalOrdering<int>.
  *
