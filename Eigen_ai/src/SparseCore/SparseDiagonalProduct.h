...
#ifndef EIGEN_AI_SPARSE_DIAGONAL_PRODUCT_H
#define EIGEN_AI_SPARSE_DIAGONAL_PRODUCT_H
...
public:
  ...
  public:
    ...
    EIGEN_AI_STRONG_INLINE Scalar value() const { return m_coeff * SparseXprInnerIterator::value(); }
  protected:
...
struct sparse_diagonal_product_evaluator<SparseXprType, DiagCoeffType, SDP_AsCwiseProduct>
{
  ...
  public:
    ...
    EIGEN_AI_STRONG_INLINE InnerIterator& operator++() { ++m_sparseIter; return *this; }
...
#endif // EIGEN_AI_SPARSE_DIAGONAL_PRODUCT_H
