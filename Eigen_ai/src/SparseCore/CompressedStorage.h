...
#ifndef EIGEN_AI_COMPRESSED_STORAGE_H
#define EIGEN_AI_COMPRESSED_STORAGE_H
...
class CompressedStorage
{
  ...
  protected:
    ...
    {
      #ifdef EIGEN_AI_SPARSE_COMPRESSED_STORAGE_REALLOCATE_PLUGIN
        EIGEN_AI_SPARSE_COMPRESSED_STORAGE_REALLOCATE_PLUGIN
      #endif
...
#endif // EIGEN_AI_COMPRESSED_STORAGE_H
