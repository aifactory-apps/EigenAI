...
#ifndef EIGEN_AI_AMBIVECTOR_H
#define EIGEN_AI_AMBIVECTOR_H
...
_Scalar& AmbiVector<_Scalar,_StorageIndex>::coeffRef(Index i)
{
  ...
  {
    ListEl* EIGEN_AI_RESTRICT llElements = reinterpret_cast<ListEl*>(m_buffer);
...
class AmbiVector<_Scalar,_StorageIndex>::Iterator
{
  public:
      ...
      : m_vector(vec)
    {
      ...
      {
        ListEl* EIGEN_AI_RESTRICT llElements = reinterpret_cast<ListEl*>(m_vector.m_buffer);
