...
#ifndef EIGEN_AI_SPARSE_TRIANGULARVIEW_H
#define EIGEN_AI_SPARSE_TRIANGULARVIEW_H
  ...
  : public SparseMatrixBase<TriangularView<MatrixType,Mode> >
{
  ...
  public:
    ...
    EIGEN_AI_SPARSE_PUBLIC_INTERFACE(TriangularViewType)
...
public:
  ...
  class InnerIterator : public EvalIterator
  {
    ...
    public:
      ...
      EIGEN_AI_STRONG_INLINE InnerIterator(const unary_evaluator& xprEval, Index outer)
      ...
      EIGEN_AI_STRONG_INLINE operator bool() const
      {
        if(HasUnitDiag && m_returnOne)
          return true;
...
#endif // EIGEN_AI_SPARSE_TRIANGULARVIEW_H
