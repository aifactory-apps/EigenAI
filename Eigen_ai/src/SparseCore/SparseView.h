...
#ifndef EIGEN_AI_SPARSEVIEW_H
#define EIGEN_AI_SPARSEVIEW_H
...
public:
  EIGEN_AI_SPARSE_PUBLIC_INTERFACE(SparseView)
  ...
  public:
    ...
    class InnerIterator : public EvalIterator
    {
      ...
      public:
        ...
        EIGEN_AI_STRONG_INLINE InnerIterator(const unary_evaluator& sve, Index outer)
  ...
  public:
    ...
    class InnerIterator
    {
      public:
        ...
        EIGEN_AI_STRONG_INLINE StorageIndex index() const { return m_inner; }
