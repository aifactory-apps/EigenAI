...
#ifndef EIGEN_AI_SPARSE_REF_H
#define EIGEN_AI_SPARSE_REF_H
...
public:
  ...
  EIGEN_AI_SPARSE_PUBLIC_INTERFACE(SparseRefBase)
...
#endif
{
  ...
  public:
    ...
    EIGEN_AI_SPARSE_PUBLIC_INTERFACE(Ref)
    ...
    {
      EIGEN_AI_STATIC_ASSERT(bool(Traits::template match<SparseMatrix<MatScalar,OtherOptions,MatIndex> >::MatchAtCompileTime), STORAGE_LAYOUT_DOES_NOT_MATCH);
...
#endif
{
  ...
  public:
    ...
    {
      EIGEN_AI_STATIC_ASSERT(bool(Traits::template match<SparseVector<MatScalar,OtherOptions,MatIndex> >::MatchAtCompileTime), STORAGE_LAYOUT_DOES_NOT_MATCH);
      Base::construct(expr.derived());
    }
