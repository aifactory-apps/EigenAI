...
#ifndef EIGEN_AI_SPARSE_SELFADJOINTVIEW_H
#define EIGEN_AI_SPARSE_SELFADJOINTVIEW_H
...
{
  EIGEN_AI_ONLY_USED_FOR_DEBUG(alpha);
...
#endif // EIGEN_AI_SPARSE_SELFADJOINTVIEW_H
