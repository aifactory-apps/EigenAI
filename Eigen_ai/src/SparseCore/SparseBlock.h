...
#ifndef EIGEN_AI_SPARSE_BLOCK_H
#define EIGEN_AI_SPARSE_BLOCK_H
...
public:
    EIGEN_AI_SPARSE_PUBLIC_INTERFACE(BlockType)
    ...
    EIGEN_AI_STRONG_INLINE Index rows() const { return IsRowMajor ? m_outerSize.value() : m_matrix.rows(); }
    EIGEN_AI_STRONG_INLINE Index cols() const { return IsRowMajor ? m_matrix.cols() : m_outerSize.value(); }
  ...
  protected:
    ...
    {
      EIGEN_AI_STATIC_ASSERT(sizeof(T)==0, THIS_SPARSE_BLOCK_SUBEXPRESSION_IS_READ_ONLY);
      return *this;
    }
};
...
public:
    ...
    {
      EIGEN_AI_STATIC_ASSERT_VECTOR_ONLY(sparse_matrix_block_impl);
...
public:
  ...
  EIGEN_AI_STRONG_INLINE InnerVectorInnerIterator(const unary_evaluator& aEval, Index outer)
...
public:
  ...
  EIGEN_AI_STRONG_INLINE OuterVectorInnerIterator(const unary_evaluator& aEval, Index outer)
    : m_eval(aEval),
