...
#ifndef EIGEN_AI_SUPERLUSUPPORT_H
#define EIGEN_AI_SUPERLUSUPPORT_H
...
#ifdef MILU_ALPHA
#define EIGEN_AI_SUPERLU_HAS_ILU
#endif

#ifdef EIGEN_AI_SUPERLU_HAS_ILU
...
struct SluMatrix : SuperMatrix
{
  ...
  void setScalarType()
  {
    ...
    {
      eigen_assert(false && "Scalar type not supported by SuperLU.h");
    }
  }
  ...
  static SluMatrix Map(MatrixBase<MatrixType>& _mat)
  {
    ...
    eigen_assert( ((MatrixType::Flags&RowMajorBit)!=RowMajorBit) && "row-major dense matrices are not supported by SuperLU.h");
    SluMatrix res;
  ...
  static SluMatrix Map(SparseMatrixBase<MatrixType>& a_mat)
  {
    ...
    eigen_assert(((MatrixType::Flags & SelfAdjoint)==0) && "SelfAdjoint matrix shape not supported by SuperLU.h");
...
struct SluMatrixMapHelper<Matrix<Scalar,Rows,Cols,Options,MRows,MCols> >
{
  ...
  {
    eigen_assert( ((Options&RowMajor)!=RowMajor) && "row-major dense matrices is not supported by SuperLU.h");
    res.setStorageType(SLU_DN);
...
#endif // EIGEN_AI_SUPERLUSUPPORT_H
