...
#ifndef EIGEN_AI_COMPLETEORTHOGONALDECOMPOSITION_H
#define EIGEN_AI_COMPLETEORTHOGONALDECOMPOSITION_H
...
class CompleteOrthogonalDecomposition {
 ...
 public:
  ...
  EIGEN_AI_DEVICE_FUNC void _solve_impl(const RhsType& rhs, DstType& dst) const;
#endif
...
#endif  // EIGEN_AI_COMPLETEORTHOGONALDECOMPOSITION_H
